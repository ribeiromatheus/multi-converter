...
const addCurrencyBtn = document.querySelector(".add-currency-btn"),
    addCurrencyList = document.querySelector(".add-currency-list"),
    currenciesList = document.querySelector(".currencies"),
    dataURL = "https://api.exchangeratesapi.io/latest",
    initiallyDisplayedCurrencies = ["USD", "EUR", "GBP", "BRL", "CAD"];
...
document.addEventListener('DOMContentLoaded', () => {
    document.querySelector('ul.add-currency-list').classList.add("invisible");
});
...
function addCurrencyBtnClick() {
    addCurrencyBtn.classList.toggle("open") ?
        document.querySelector('ul.add-currency-list').classList.remove("invisible") :
        document.querySelector('ul.add-currency-list').classList.add("invisible");
}
